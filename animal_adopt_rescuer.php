...
if(isset($_POST["donation"])){
    ...
    $pdo->exec("INSERT INTO `adoptions`(`animal_id`, `donation`, `adoped_by_category`, `mixedId`, `driverId`, `adoption_date`) VALUES ('$animal_id', '$donation', 'rescuer', '$rescuer', '$driver', '$date')");
...
$stm = $pdo->query("SELECT * FROM driver");
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Adopt Animal - by Rescuer
                                        <div class="page-title-subheading">Adopt Animal - by Rescuer
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body"><h5 class="card-title">Details</h5>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="position-relative form-group"><label for="exampleEmail11" class="">Moving to Shelter </label>
                                                        <select class="mb-2 form-control" name="rescuer">
                                                            <?foreach($rows as $row) {?>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="position-relative form-group"><label for="exampleEmail11" class="">Driver </label>
                                                        <select class="mb-2 form-control" name="driver">
