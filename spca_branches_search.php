                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>All SPCA Branches
                                        <div class="page-title-subheading">All SPCA Branches Data can be found here
                                        </div>
                                    </div>
                                </div>
                                   </div>
                                            ...
                                            foreach($rows as $row) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="./spca_branches_details.php?spca_id=<?echo $row[0]?>" class="btn-shadow mr-3 btn btn-success">
