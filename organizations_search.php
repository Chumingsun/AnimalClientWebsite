                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>All Organizations
                                        <div class="page-title-subheading">All Organizations Data can be found here
                                        </div>
                                    </div>
                                </div>
                                   </div>
                                            ...
                                            foreach($rows as $row) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="./organization_details.php?org_id=<?echo $row[0]?>" class="btn-shadow mr-3 btn btn-success">
