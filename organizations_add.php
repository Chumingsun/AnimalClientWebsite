...
if(isset($_POST["name"]) && isset($_POST["phone"])){
    ...
    $orgId = generateRandomString(5);
    
    $pdo->exec("INSERT INTO `organizations`(`org_id`, `org_name`, `phone_number`, `address_number`, `street`, `building_number`, `city`, `province`, `postal_code`) VALUES ('$orgId', '$name', '$phone', '$address', '$street', '$building', '$city', '$province', '$postalCode')");
    
    ?><script type="text/javascript">window.location = "./organizations_search.php";</script><?
                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Add Organization
                                        <div class="page-title-subheading">Add a new Organization
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="page-title-actions">
                                    <input type="submit" class="btn-shadow mr-3 btn btn-success" value="Add Organization "/>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body"><h5 class="card-title">New Organization Details</h5>
